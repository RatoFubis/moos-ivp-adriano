...
echo "x=0,y=-25,heading=180"  >> vpositions.txt
echo "x=80,y=-25,heading=180" >> vpositions.txt

echo "x=0,y=-75"    >  vlocations.txt
echo "x=125,y=-50" >> vlocations.txt
echo "x=0,y=-125"  >> vlocations.txt
echo "x=125,y=-125" >> vlocations.txt

pickpos --amt=$VEHICLE_AMT --spd=1:1.2 > vspeeds.txt 
pickpos --amt=$VEHICLE_AMT --vnames=henry,gilda,abe,ben  > vnames.txt
